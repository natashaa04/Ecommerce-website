...
//			e.printStackTrace();)
	...
	public ResponseEntity<OrderDto> placeOrder(@RequestBody PlaceOrderDto placeOrderDto) {
	 ...
	 @DeleteMapping("/cart/removeItem")
	    public ResponseEntity<?> removeProductFromCart(@RequestBody AddProductInCartDto addProductInCartDto) {
	        return cartService.removeProductFromCart(addProductInCartDto);
	    }
